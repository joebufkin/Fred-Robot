...
const double TICKS_PER_REVOLUTION = 322; // For reference purposes.
const double WHEEL_RADIUS = 0.051; // Wheel radius in meters
const double WHEEL_BASE = 0.356; // Center of left tire to center of right tire
const double TICKS_PER_METER = 1000; // Original was 2800
